...
**「日本の学校教員・教育関係者に向けた、教育ニュース + 研究発信のキュレーションサイト」**

文科省・国立教育政策研究所・教育専門紙・共同通信(教育)から、教育実務に関わる情報を自動収集し、エビデンス視点で整理して毎日配信する。週 1 回、編集者による「今週のハイライト(論点整理付き)」を金曜朝に公開する。

対象読者の確定経緯: PRD v1.0 では教員と保護者の 2 層を併記していたが、ADR 0018(2026-05-01)で「学校教員・教育関係者」に統一した。詳細は §3 と ADR 0018 を参照。
...
> **改定**: ADR 0018(2026-05-01)で対象読者を「学校教員・教育関係者」に統一。本節は改定後の定義。

### 3.1 プライマリ読者

- **小・中・高等学校の現場教員**(20〜50 代)
...
- 保護者(子育て情報・受験対策・習い事を主目的とする層)

ただし保護者向けの一次情報(調査・政策)で **教員視点で関連する場合**(家庭との連携・情報モラル指導・進路指導・経済格差と学習機会など)は引き続き採用する。
...
目的は「今、教員・教育関係者の間で何が話題になっているか」の把握。**収集対象ではなく、金曜朝の週次ダイジェスト編集時の参考指標** として扱う。話題になっている案件があれば、一次資料に遡って確認した上でダイジェストに取り上げるか判断する。
...
- 重大事件の被害者特定につながる情報
- 保護者の私的関心に閉じる純情報(中学受験対策・幼児教育のおすすめ・習い事ランキング・ファッション/ライフスタイル系の家庭情報)。教員視点で関連する場合のみ採用する(ADR 0018)
