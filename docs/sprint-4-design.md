...
| §12 KPI: 30 分以内編集 / 100% 公開率 | テンプレート化された frontmatter + Content Collection の型補完で編集を高速化 |
...
このゲートを通すことで、PRD §12 の KPI(30 分以内編集 / 100% 公開率)を維持しながら、edu-watch のブランド(信頼最優先、商業メディアと差別化)を構造で担保する。
